...
export const slides: Slide[] = [
    {
        id: 1,
        title: "Горячая вода: здоровье и отдых",
        description:
    ...
    {
        id: 2,
        title: "RGB-подсветка и хромотерапия",
        description:
    ...
    {
        id: 3,
        title: "Гейзер: лёгкость для тела",
        description:
