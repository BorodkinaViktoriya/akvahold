...
export const TubFeatures: features[] = [
  ...
  },
  {
    id: 2,
    title: "Борт-волнорез",
    image: "/images/kupeli/specs/bort.png",
    info: "П-образная форма борта удерживает воду внутри купели даже при активном купании. Вам не придётся доливать холодную воду, заново ждать нагрева и прерывать отдых в самый приятный момент",
  },
  {
    id: 3,
